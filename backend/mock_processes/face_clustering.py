...
faces_folder_path = "/home/atlantis/Documents/Project/python_proge/selti_naoraamat/backend/data/pildid/reduced/2024-l/Aastapäev/Aastapäev_Heino Pärn" # sys.argv[3]
output_folder_path = "/home/atlantis/Documents/Project/python_proge/selti_naoraamat/backend/temp"  #sys.argv[4]
...
for i, index in enumerate(indices):
    ...
    dlib.save_face_chip(img, shape, file_path, size=150, padding=0.5)
